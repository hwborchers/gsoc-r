...
To find the accepted and successful GSoC-R projects from 2009 to 2014, go to one of the Melange pages
...
or "Select Program" on the right, and then click on "Accepted Projects" on the left. In the table that appears, enter "R Project for Statistical Computing" (2010-2014) or "R Foundation for Statistical Computing" (2009) as 'Organization', and the accepted successful projects of that year will get listed.
